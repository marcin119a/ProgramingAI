...
## Zadanie — Udostępnienie modelu przez API (FastAPI)
...
Masz już wytrenowany model (np. `model_random_forest_adresowo_lodz.pkl`) .
...
3. Dodaj endpoint `/train_model/`, który ponownie trenuje model i zapisuje go do pliku.
